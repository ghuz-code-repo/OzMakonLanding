...
const USPGridSlide = React.forwardRef(({ slide, imgPath, colClass = '', height }, ref) => (
  <div className="usp5-wrapper" ref={ref} style={{ maxHeight: height }}>
